        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=clientes" id="ingresar" method="POST">
                    ...
                    <div class="form-group">
                        <label>Ci</label>
                        <input type="text" name="add_Ci" id="add_Ci" class="form-control" placeholder="Ci" onkeypress="return validarNumero(event)" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=clientes" method="POST">
                    ...
                    <div class="form-group">
                        <label>Apellido Paterno</label>
                        <input type="text" name="ApellidoP" id="ApellidoP" class="form-control" onkeypress="return validarTexto(event)" required>
                    </div>
                    <div class="form-group">
                        <label>Apellido Materno</label>
                        <!-- Corrected the name to match PHP variable -->
                        <input type="text" name="ApellidoM" id="ApellidoM" class="form-control" onkeypress="return validarTexto(event)" required>
                    </div>
                    <div class="form-group">
                        <label>Ci</label>
                        <!-- Corrected the name to match PHP variable -->
                        <input type="text" name="Ci" id="Ci" class="form-control" onkeypress="return validarNumero(event)" required>
                    </div>
                    <div class="form-group">
                        <label>Telefono</label>
                        <input type="text" name="Telefono" id="Telefono" class="form-control" onkeypress="return validarNumero(event)" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
